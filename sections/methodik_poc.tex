...
Technisch werden das 360°-Cockpit wie das Governance-Cockpit mittels einer Python Anwendung mit Fast-API implementiert. Die Nutzung des Python Setups begründet sich damit, dass die CLIs von Anbietern wie Azure und AWS auf Pyhton basieren. Des Weiteren ermöglicht Fast-API mit vergleichbaren geringen Aufwand eine restful Service zu erstellen. Um die Trennung der beiden Cockpit Komponenten zu betonen passieren gegenseite Aufrufe jeweils via HTTP Inteface. Zur Persistierung verwenden die Komponenten Project Collection, Evidence Collection sowie es Governance Decision Store wie Governance Intent Repository eine Mongo No-Sql Document Database. Die Wahl einer Document Database begründet sich mit der Abbildung der Traceability-Beziehung als JSON-Objekte, was eine Handhabung aus implementatorischer Sicht vereinfacht. Für den Landing Zone Plattform Configuration Service wird ein statisches IaC Setup mit Terraform verwendet. Die modellierten Traceability-Beziehungen werden hierbei als statischer Inhalt geteilt. Über das Setup hinaus werden weitere Cloud-Ressourcen  erzeugt welche in einem funktionalen Setup bereits als gegeben angenommen werden:
...
Die Traceability-Beziehungen werden basierend auf dem Basismodell in \autoref{sec:trace-arch-variant2} modelliert und im Rahmen der Umsetzung adaptiert
...
Im Sinne der didaktischen Veranschaulichung einer Traceability-Architektur wir der PoC aus Sicht der verschiedenen Use-Cases beschrieb
