...
\begin{longtable}{|
  ...
  L{3cm}|
    ...
    Sehr relevant, da die Cloud-Plattformen im \ac{uc} des BIT noch nicht feststehen. Die betrachteten Plattformen Azure und AWS werden lediglich als Beispieke verwedet. Eine Anwendbarkeit auf weitere Cloud-Plattformen ist jedoch essentiel & \cite{mirsalari_model_2020}
    \\
    \hline
