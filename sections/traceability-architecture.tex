...
\textbf{Ansatz}: Für jede Control in der jeweiligen Verordnung wird ein Mapping zu einem Plattform-Bundle gemacht. Also eine Control beinhaltet Plattform-Policies X, Y und Z. Beim deployen einer \ac{lz} wählt das Blueprint aus welche Controls benötigt werden (z.B. keine Baseline, erhöhter Schutzbedarf, etc.)
