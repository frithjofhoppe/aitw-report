...
Für Evaluation wird eine Auswahl an Architekturprinzipien aus \autoref{fig:bit-architecture-principles} und \autoref{tab:architecture-principles} vorgenommen, um sich auf wesentliche Aspekte für den Kontext zu Beschränken

\begin{enumerate}
    \item Definieren vom Kontext und darauf aufbauend Leitgedanken, mit welchen die Bestimmung von Parametern hergeleitet werden kann
    \item Bestimmen der Architekturprinzipien nach MUSS und KANN
    \item Bestimmen der Gewichte der Qualitätsmerkmale
    \item Bestimmen der Präferenz der Trade-Off Dimensionen
