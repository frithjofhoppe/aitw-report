...
Mittels der verschiedenen Dimensionen wird ein Bewertungs-/Validierungsprozess definiert. Das Ziel dieses Prozesses ist es die Dimensionen in eine Beziehung zueinander zu setzen und schlussendlich einen punkte-/notenbasierten Output zu bekommen. Mit diesem Output soll schlussendlich eine Aussage getroffen werden können für den Kontext.

Der Prozess bestehe aus den folgenden Teilen:

\begin{enumerate}
    \item Definieren von Bewertungskontexten und darauf aufbauend Gewichtungsleitgedanken, mit welchen die Gewichtungsfaktoren bestimmt werden
    \item Kategorisieren der Architekturprinzipien nach MUSS und KANN
