...
\begin{longtable}{|
  ...
  L{3cm}|
    ...
    A5 & 2 & \textbf{Product Neutrality} \hypertarget{architecture-a5}{} Die Sicherheitsvorgaben im BIT adressieren Anforderungen und keine Herstellerprodukte &
    Herstellerspezifische Konzepte sollten bereits auf der Ebene der Architektur ausgeschlossen werden und höchstens konzeptionell betrachtet werden & Auszug aus \autoref{fig:bit-architecture-principles}
    \\
    \hline
...
\begin{longtable}{|
  ...
  L{3cm}|
    ...
    Die Fähigkeit zum Automatisieren ist einer der Hauptgründe für die Relevanz der Traceability & \hl{Quellen ergänzen} Beschreibung des Kontextes
    \\
    \hline
