...
Im \ac{poc} ist für die Traceability der statisch konfigurierte Inhalte des Governance Configuration Service am relevantesten. Für die implementierte component-cenctric Variante werden dafür zuerst exemplarische Controls aus der Regulation \ac{si001}. Die verwendeten Controls in \autoref{fig:methodology-poc-traceability-relationship-components} sind dabei \hl{hier weiter machen}
